...
public class Gen3NewWarpConstants {
    ...
    public static final String rsPokemonNamesPointerSuffix = "30B50025084CC7F7"; //NEWWARP CHANGED 
    ...
    public static final String pokedexOrderPointerPrefix = "0448814208D0481C0004000C05E00000"; //NEWWARP CHANGED: I gave up on this one - it was much, much easier just to manaully find this in the ROM

    public static final String rsFrontSpritesPointerPrefix = "05E0"; //not going to worry about this one - see comments in NewWarp handler

    public static final String rsFrontSpritesPointerSuffix = "1068191C"; //not going to worry about this one - see comments in NewWarp handler

    public static final String rsPokemonPalettesPointerPrefix = "04D90148006817E0"; //not going to worry about this one - see comments in NewWarp handler

    public static final String rsPokemonPalettesPointerSuffix = "080C064A11404840"; //not going to worry about this one - see comments in NewWarp handler
    ...
    public static final int bsHPOffset = 0, bsAttackOffset = 1, bsDefenseOffset = 2, bsSpeedOffset = 3,
            ...
            bsGrowthCurveOffset = 21, bsAbility1Offset = 24, bsAbility2Offset = 25;
    ...
    public static final int evolutionMethodCount = 30;
